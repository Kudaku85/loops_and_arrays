...
class Ticket {
    ...
    public Ticket(String name, String ticketStatus) {
        this.name = name;
...
public class Main {
    public static void main(String[] args) {
        ...
        while (ticketCount < planeCapacity) { //Starter en while-loop.
            ...
            if (!name.isBlank()) { //Sjekker om navnet er blankt. Hvis det er det trigges ikke if-funksjonen og loopen begynner på nytt.
                Ticket freshTicket = new Ticket(name, "gyldig"); //Hvis navnet ikke er blankt bruker vi det til å opprette en ny billett
